...
const commonOpts = {
  maxRetriesPerRequest: null,   // BullMQ + Upstash
  enableReadyCheck: false,      // Serverless/Upstash
  connectTimeout: 5000,
  keepAlive: 1,
};

if (redisUrl && redisUrl.startsWith("rediss://")) {
  redis = new Redis(redisUrl, { tls: {}, ...commonOpts });
} else {
  redis = new Redis(redisUrl, { ...commonOpts });
}
